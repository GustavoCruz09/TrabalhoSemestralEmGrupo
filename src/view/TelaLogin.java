// O CODIGO PRECISA SER INICIADO POR ESSA CLASSE
...
import controller.IVerificaLogin;
...
//	public static boolean Status = true;
	...
	public TelaLogin() {
		...
		IVerificaLogin login = new VerificaLogin(tfLUsuario, tfLSenha, this);
		btnLEntrar.addActionListener((ActionListener) login);
		btnLCadastrar.addActionListener((ActionListener) login);
	}
}
