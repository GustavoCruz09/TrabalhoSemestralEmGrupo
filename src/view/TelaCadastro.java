...
import controller.IVerificaCadastro;
...
public class TelaCadastro extends JFrame {
	...
	public TelaCadastro() {
		...
		IVerificaCadastro vc = new VerificaCadastro(tfCUsuario, tfCSenha, tfCConfirmaSenha, this);
		btnCConfirma.addActionListener((ActionListener) vc);
